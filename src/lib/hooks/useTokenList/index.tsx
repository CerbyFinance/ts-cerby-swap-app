...
export const DEFAULT_TOKEN_LIST = 'https://tokens.cerbyswap.com/1'
...
function useChainTokenMapContext() {
  ...
  if (chainTokenMap === MISSING_PROVIDER) {
    throw new Error('PoolList hooks must be wrapped in a <TokenListProvider>')
  }
...
export function TokenListProvider({
  ...
  }, [chainTokenMap, list, resolver, chainId])
