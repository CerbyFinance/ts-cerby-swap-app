...
import { ANKR_NETWORK_URLS } from 'constants/ankr'
...
const [walletConnect] = initializeConnector<WalletConnect>(
  (actions) => new WalletConnect(actions, { rpc: ANKR_NETWORK_URLS })
)
...
export default function Wrapper({ children }: { children: ReactNode }) {
  ...
  const [jsonRpcEndpoint] = useSelect('JSON-RPC', {
    defaultValue: ANKR_NETWORK_URLS[SupportedChainId.MAINNET],
    options: [NO_JSON_RPC, ...Object.values(ANKR_NETWORK_URLS).sort()],
  })
