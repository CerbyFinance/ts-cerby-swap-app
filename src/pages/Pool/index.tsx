...
import { ButtonGray, ButtonLight, ButtonPrimary, ButtonText } from 'components/Button'
...
import { BookOpen, Inbox } from 'react-feather'
...
const ResponsiveButtonGray = styled(ButtonLight)`
  border-radius: 12px;
  padding: 6px 8px;
  width: fit-content;
  margin-right: 5px;
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            <TitleRow style={{ marginTop: '1rem' }} padding={'0'}>
              ...
              <ButtonRow>
                ...
                <ResponsiveButtonGray
                  id="learn-pool"
                  as={Link}
                  to="https://docs.cerby.fi/our-products/cerbyswap/user-guides"
