...
export const CERUSD = new Token(
  SupportedChainId.MAINNET,
  '0x3B69b8C5c6a4c8c2a90dc93F3B0238BF70cC9640',
  18,
  'CerUSD',
  'CerUSD'
)

// export const CERUSD: { [chainId in SupportedChainId]: Token } = {
...
//   [SupportedChainId.MAINNET]: new Token(SupportedChainId.MAINNET, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
//   [SupportedChainId.RINKEBY]: new Token(SupportedChainId.RINKEBY, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
//   [SupportedChainId.ROPSTEN]: new Token(SupportedChainId.ROPSTEN, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
//   [SupportedChainId.GOERLI]: new Token(SupportedChainId.GOERLI, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
//   [SupportedChainId.KOVAN]: new Token(SupportedChainId.KOVAN, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
// }
