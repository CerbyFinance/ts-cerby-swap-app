...
export default function FeeSelector({
  ...
  const { isLoading, isError, largestUsageFeeTier, distributions } = useFeeTierDistribution(currencyA)

  // get pool data on-chain for latest states
  const pools = usePools([
    [currencyA, FeeAmount.LOWEST],
    [currencyA, FeeAmount.LOW],
    [currencyA, FeeAmount.MEDIUM],
    [currencyA, FeeAmount.HIGH],
  ])
