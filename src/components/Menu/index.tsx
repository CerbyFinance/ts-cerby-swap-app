          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://docs.cerby.fi/our-products/cerbyswap/protocol-overview">
                      <div>
                        <Trans>About</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    {/* <MenuItem href="https://help.cerby.fi/">
                      <div>
                        <Trans>Help Center</Trans>
                      </div>
                      <HelpCircle opacity={0.6} size={16} />
                    </MenuItem> */}
                    <MenuItem href="https://t.me/CerbyToken">
                      <div>
                        <Trans>Telegram</Trans>
                      </div>
                      <Send opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://discord.gg/w89sgr9WAZ">
                      <div>
                        <Trans>Discord</Trans>
                      </div>
                    ...
                    <MenuItem href="https://docs.cerby.fi/our-products/cerbyswap">
                      <div>
                        <Trans>Docs</Trans>
                      </div>
